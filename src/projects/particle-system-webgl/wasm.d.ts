...
interface EmbindModule {
  ...
  createParticles(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  ...
  calcCoordinates(_0: number, _1: number, _2: number, _3: boolean, _4: number, _5: number, _6: number, _7: boolean, _8: boolean, _9: boolean): any;
}
